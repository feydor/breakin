...
# targets = [
#     Target(x=100, y=TARGET_GROUP_TOP),
#     Target(x=100 + TARGET_WIDTH + TARGET_PADDING, y=TARGET_GROUP_TOP),
#     Target(x=100 + 2*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP),
#     Target(x=100 + 3*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP),
#     Target(x=100 + 4*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP),
#     Target(x=100 + 5*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP),
#     Target(x=100 + 6*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP),

#     Target(x=100, y=TARGET_GROUP_TOP + TARGET_PADDING + TARGET_HEIGHT),
#     Target(x=100 + TARGET_WIDTH + TARGET_PADDING, y=TARGET_GROUP_TOP + TARGET_PADDING + TARGET_HEIGHT),
#     Target(x=100 + 2*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP + TARGET_PADDING + TARGET_HEIGHT),
#     Target(x=100 + 3*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP + TARGET_PADDING + TARGET_HEIGHT),
#     Target(x=100 + 4*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP + TARGET_PADDING + TARGET_HEIGHT),
#     Target(x=100 + 5*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP + TARGET_PADDING + TARGET_HEIGHT),
#     Target(x=100 + 6*(TARGET_WIDTH + TARGET_PADDING), y=TARGET_GROUP_TOP + TARGET_PADDING + TARGET_HEIGHT),
# ]
